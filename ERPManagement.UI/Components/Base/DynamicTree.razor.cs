...
{
    public partial class DynamicTree<TModel> where TModel : class, new()
    {
        ...
        [Parameter] public Func<TModel, string> GetNum { get; set; }
        ...
        private RenderFragment RenderNode(TreeNode node) => builder =>
        {
            ...
            if (node.Children.Any())
            {
                ...
                builder.AddContent(6, node.Num + " - " + node.Text);
                builder.CloseElement();
            ...
            else
            {
                ...
                builder.AddContent(14, node.Num + " - " + node.Text);
                builder.CloseElement();
            }
